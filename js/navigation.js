...
const saitMain = document.querySelector('.site-main');
...
const dropBtn = document.querySelector('.menu-item-has-children');
...
if (dropBtn.classList.contains('drop')) {
	subMenu.classList.remove('droped');
	dropBtn.classList.remove('drop');
} else {
	subMenu.classList.add('droped');
